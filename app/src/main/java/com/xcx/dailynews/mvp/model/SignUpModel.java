...
public class SignUpModel extends BaseModel {
    ...
    protected void getDataFromModel(String type, String channelId, int loadType, int pageNum) {
        ...
        newsService.signUpService(ApiConstants.SIGN_UP_URL,type,channelId)
                .subscribeOn(Schedulers.io())
                .observeOn(Schedulers.io())
                .map(new SignUpResultFun1())
                .observeOn(AndroidSchedulers.mainThread())
                .subscribe(new MySubscriber<LoginBean>(5));
    }
    class SignUpResultFun1 implements Func1<String, List<LoginBean>> {
